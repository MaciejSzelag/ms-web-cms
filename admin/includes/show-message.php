...
<div class="message-wrap">
    <div class="msg-box message-header">
        <h1>Message from <span><?php echo $visitor_name; ?></span></h1>
        <h2>Category: <span><?php echo $category_name; ?></span></h2>
        <h2>Email: <span><?php echo $visitor_email; ?></span></h2>
        <h2>Phone: <span><?php echo $visitor_phone_no; ?></span></h2>
    </div>
    ...
    <div class="msg-box actions">
        <button><a href="index.php?source=contact-form-table&delete=<?php echo $msg_id;?>">Delete</a></button>
    </div>
